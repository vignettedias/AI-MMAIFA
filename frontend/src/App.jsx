...
function App() {
  ...
  const systemStats = useMemo(
    () => [
      { label: 'Pixel Experts', value: 'Foundation, frequency, and generator specialists', icon: Cpu },
      { label: 'Forensics', value: 'Noise, diffusion, provenance, and spectral probes', icon: ShieldCheck },
      { label: 'Semantic Agents', value: 'Anatomy, typography, geometry, physics', icon: Sparkles },
    ],
    [],
  )
        ...
        <header className="grid gap-5 rounded-md border border-slate-200 bg-white p-5 shadow-sm lg:grid-cols-[1fr_420px] lg:items-center">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
              Upload an image and review stream evidence, uncertainty, open-set risk, and analyst feedback paths.
            </p>
          </div>
